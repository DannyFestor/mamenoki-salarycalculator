...
return [
    ...
    'attributes' => [
        ...
        'work_system' => '勤務体制',
        'daily_hours' => '1日の勤務時間',
        'has_parking_spot' => '駐車場の利用',
        'has_meal' => '給食の利用',
        'has_break' => '休憩',
        'has_health_insurance' => '健康保険',
        'has_welfare_pension' => '厚生年金',
        'has_nursing_insurance' => '介護保険',
        'has_unemployment_insurance' => '雇用保険',
        'monthly_employee_base_salary' => '基本給（月給職員）',
        'monthly_employee_base_salary_hourly' => '基本給（月給の時給換算）',
        'hourly_employee_base_salary' => '基本給（時給職員）',
        'treatment_improvement_1' => '処遇改善①',
        'treatment_improvement_2' => '処遇改善②',
        'position_allowance' => '役職手当(8%)',
        'job_title_allowance' => '役職手当(4%)',
        'qualification_allowance' => '資格手当（看護師や栄養士）',
        'housing_allowance' => '住居手当',
        'dependent_care_allowance' => '扶養手当',
        'commuting_allowance_monthly' => '通勤手当（月払い）',
        'commuting_allowance_workdays' => '通勤手当（出勤回数）',
        'municipal_inhabitant_tax' => '市町村民税',
        'refund_of_withholding_tax' => '源泉徴収還付金',
        'income_tax' => '所得税（副業扱い）',
    ],
];
